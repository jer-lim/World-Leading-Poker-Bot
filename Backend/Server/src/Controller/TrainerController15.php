...
use Model\Factor15\Benchmark;
use Model\Factor15\Result;
use Model\Factor15\Weight;

class TrainerController15
{
    ...
    public function t()
    {
        $this->populateBenchmark(1);
        $this->populateBenchmark(2);
        $this->populateBenchmark(3);
    }
